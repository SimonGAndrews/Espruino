...
$(RP2040_CMAKEFILE): FORCE
	...
	@echo "target_link_libraries($(RP2040_TARGET) pico_stdlib pico_unique_id hardware_adc hardware_pwm tinyusb_device tinyusb_board tinyusb_additions)" >> $(RP2040_CMAKEFILE)
