...
$(RP2040_CMAKEFILE): FORCE
	...
	@echo "target_link_libraries($(RP2040_TARGET) pico_stdlib)" >> $(RP2040_CMAKEFILE)
	@echo "pico_enable_stdio_usb($(RP2040_TARGET) 1)" >> $(RP2040_CMAKEFILE)
	@echo "pico_enable_stdio_uart($(RP2040_TARGET) 0)" >> $(RP2040_CMAKEFILE)
